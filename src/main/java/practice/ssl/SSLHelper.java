package practice.ssl;

import practice.protoc.AddressBookProtos;
...
public class SSLHelper {
    ...
    public static SSLServerSocketFactory newSSLSocketFactory(final InputStream cert
    ...
    public static SSLContext newSSLContext(final InputStream cert
            , final String password
            , final String ksType
            , final String ksAlgorithm) throws InvalidSSLConfig {
        try {
    ...
    public static SSLContext newSSLContext(final KeyStore ks
            , final String password
            , final String ksAlgorithm) throws InvalidSSLConfig {
        try {
