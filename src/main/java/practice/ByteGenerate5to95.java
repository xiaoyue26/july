 ...
 * @author xiaoyue26
 */
public class ByteGenerate5to95 {
    ...
    private static void fill_data(byte[] data, int percent) {
        int tmp;
     ...
     * @throws IOException
     */
    public static void writeWithMappedByteBuffer(int percent) throws IOException {
        File file = new File("/data/lzma/input/data" + percent);
        if (file.exists()) {
            file.delete();
        }
